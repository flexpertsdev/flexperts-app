    ...
    <div class="relative z-10 w-full max-w-md">
      ...
      <div class="bg-primary rounded-2xl shadow-xl p-8 border border-primary">
        ...
        <div class="flex bg-tertiary rounded-lg p-1 mb-8">
          <router-link to="/login" class="flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all duration-200 text-tertiary text-center">
            Login
          </router-link>
        ...
        <form @submit.prevent="handleSignup" class="space-y-6">
          ...
          <div>
            ...
            <input 
              ...
              required
            >
            <p class="mt-2 text-sm text-tertiary">Must be at least 8 characters</p>
          </div>
          ...
          <div class="flex items-start">
            <input 
              ...
              type="checkbox" 
              id="terms" 
              class="w-4 h-4 brand-primary rounded border-secondary focus:ring-2 focus:ring-offset-0 focus:ring-green-500 mt-0.5"
              required
            >
            <label for="terms" class="ml-2 text-sm text-secondary">
              I agree to the <a href="#" class="brand-primary-text hover:opacity-80">Terms of Service</a> 
              and <a href="#" class="brand-primary-text hover:opacity-80">Privacy Policy</a>
            </label>
          </div>
          ...
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-primary text-tertiary">Or sign up with</span>
            </div>
          </div>

          <div class="grid grid-cols-2 gap-3">
            <button type="button" @click="handleGoogleSignup" class="flex items-center justify-center px-4 py-2.5 border border-primary rounded-lg hover:bg-tertiary transition-colors">
            ...
            <button type="button" @click="handleGithubSignup" class="flex items-center justify-center px-4 py-2.5 border border-primary rounded-lg hover:bg-tertiary transition-colors">
      ...
      <p class="text-center mt-8 text-sm text-secondary">
        ...
        <router-link to="/login" class="brand-primary-text hover:opacity-80 font-medium ml-1">
          Sign in
        </router-link>
      </p>
    </div>
